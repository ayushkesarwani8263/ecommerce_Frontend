...
import {
  ...
  selectAllProduct,
  fetchProductByFiltertAsync,
  selectTotalItems,
  selectCategories,
  selectBrands,
  fetchAllCategorysAsync,
  fetchAllBrandsAsync,
...
export default function AdminProductList() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchProductByFiltertAsync({ filter, sort, pagination,admin:true}));
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <Link to="/admin/AdminProductFormPage" className="rounded-md bg-green-600 mx-10 my-2 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                    Add New Product
                  </Link>
                    ...
                    >
                      ...
                      <div className="mt-4 flex justify-between">
                        <div>
                          ...
                          <StarIcon className="w-5 h-5 inline  text-gray-500"></StarIcon>
                      ...
                      {product.stock===0 && (<div><p className="text-sm text-red-400">out of stock</p></div>)}
                    </div>
                  </Link></div>
                  <Link to={`/admin/AdminProductFormPage/edit/${product.id}`} className="rounded-md bg-indigo-600 mx-2   px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                Edit Product
              </Link>  
                </div>
                </>
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <div
          onClick={() => PageHandler(page > 1 ? page - 1 : page)}
          className="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
        >
          Previous
        </div>
        <div
          onClick={() => PageHandler(page < totalPages ? page + 1 : page)}
